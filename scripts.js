...
function ram() {
    switch (parseInt(_f('dtls')[2].value)) {
        ...
        default: alert(_f('dtls')[2].value + 'invalid Selection Ram'); break;
    }
}
function storage() {
    switch (parseInt(_f('dtls')[3].value)) {
        ...
        default: alert(_f('dtls')[3].value + 'invalid Selection Storage'); break;
    }
}
function cpu() {
    switch (parseInt(_f('dtls')[4].value)) {
        ...
        default: alert(_f('dtls')[4].value + 'invalid Selection cpu'); break;
    }
}
function display() {
    switch (parseInt(_f('dtls')[5].value)) {
        case 1: return 0; break;
